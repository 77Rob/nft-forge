...
export default async function handler(
  ...
  console.log("x");
  const metadataFilePath = `./public/data/${userId}/collections/${collectionId}/metadata.json`;
  const metadataDirectory = `./public/data/${userId}/collections/${collectionId}/metadata/`;
